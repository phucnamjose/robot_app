...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        layoutWidget5->setGeometry(QRect(10, 30, 111, 351));
        ...
        pushButton->setGeometry(QRect(50, 330, 91, 31));
        QFont font1;
        font1.setPointSize(12);
        font1.setBold(true);
        font1.setWeight(75);
        pushButton->setFont(font1);
        widget = new QWidget(groupBox_Teach);
        widget->setObjectName(QStringLiteral("widget"));
        widget->setGeometry(QRect(20, 40, 160, 120));
        ...
        pushButton_X_inc = new QPushButton(widget);
        ...
        pushButton_X_dec = new QPushButton(widget);
        ...
        pushButton_Y_inc = new QPushButton(widget);
        ...
        pushButton_Y_dec = new QPushButton(widget);
        ...
        pushButton_Z_inc = new QPushButton(widget);
        ...
        pushButton_Z_dec = new QPushButton(widget);
        ...
        pushButton_Roll_inc = new QPushButton(widget);
        ...
        pushButton_Roll_dec = new QPushButton(widget);
        ...
        widget1->setGeometry(QRect(20, 180, 160, 120));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        groupBox_Teach->setTitle(QApplication::translate("MainWindow", "Teach", Q_NULLPTR));
